 ...
 * @author limeng
 * 
 *	creates the whole playground
 *
 *	check, set, update the current falling block;
 *
 *	decide whether the falling block could fall/shift/rotate and
 *	fall/shift/rotate the falling block;
 *
 *	check whether a row is full with filled cells then
 *	remove them if any;
 *
